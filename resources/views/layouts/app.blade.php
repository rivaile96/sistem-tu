...
<body class="h-full font-sans antialiased text-gray-900" x-data="{ sidebarOpen: false }">
    ...
    <aside 
        ...
        <nav class="flex-1 overflow-y-auto custom-scroll px-3 py-6 space-y-2">
            <p class="px-3 text-[10px] font-bold text-blue-100 uppercase tracking-widest mb-2 opacity-70">Menu</p>
            ...
            <a href="{{ route('spp.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm transition font-medium {{ request()->routeIs('spp.*') ? 'bg-white text-[#0ea5e9] shadow-md' : 'text-blue-50 hover:bg-white/10 hover:text-white' }}">
