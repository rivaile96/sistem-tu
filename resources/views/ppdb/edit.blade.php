<x-app-layout>
    ...
    <div class="mb-8">
        <div class="flex items-center gap-3 mb-2">
            ...
            <div>
                <h1 class="text-3xl font-bold text-gray-900">Edit Data Calon Siswa</h1>
                <p class="text-sm text-gray-500 mt-0.5">{{ $siswa->name }}</p>
            </div>
        </div>
        <nav class="flex items-center gap-2 ml-12 text-sm text-gray-500">
            ...
            <a href="{{ route('ppdb.show', $siswa->id) }}" class="hover:text-[#0284c7] transition-colors">{{ $siswa->name }}</a>
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
            </svg>
    ...
    <form action="{{ route('ppdb.update', $siswa->id) }}" method="POST">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <input type="text" id="birth_place" name="birth_place" value="{{ old('birth_place', $siswa->birth_place) }}"
                ...
                <div>
                    ...
                    <input type="date" id="birth_date" name="birth_date"
                           value="{{ old('birth_date', $siswa->birth_date?->format('Y-m-d')) }}"
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="address" name="address" rows="3"
                              ...
                              class="w-full border border-gray-200 rounded-xl px-4 py-2.5 focus:ring-2 focus:ring-[#0284c7]/20 focus:border-[#0284c7] outline-none text-sm transition-all duration-200 resize-none @error('address') border-red-400 focus:border-red-400 focus:ring-red-200 @enderror">{{ old('address', $siswa->address) }}</textarea>
                    @error('address')
                    <p class="mt-1.5 text-xs text-red-600 flex items-center gap-1">
                        <svg class="w-3.5 h-3.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <input type="text" id="parent_name" name="parent_name" value="{{ old('parent_name', $siswa->parent_name) }}"
                ...
                <div>
                    ...
                    <input type="text" id="parent_phone" name="parent_phone" value="{{ old('parent_phone', $siswa->parent_phone) }}"
                           placeholder="Contoh: 08123456789"
        ...
        <div class="flex items-center justify-end gap-3">
            <a href="{{ route('ppdb.show', $siswa->id) }}"
