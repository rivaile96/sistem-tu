    ...
    <div class="py-12 bg-gray-50/50 min-h-screen">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow-xl sm:rounded-2xl p-8 border border-gray-100 relative overflow-hidden">
                ...
                <div class="absolute top-0 right-0 -mt-4 -mr-4 w-32 h-32 bg-indigo-50 rounded-full blur-2xl opacity-50"></div>
                ...
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 relative z-10 gap-4">
                    ...
                    <a href="{{ route('bills.index') }}" class="group flex items-center gap-2 text-gray-500 hover:text-indigo-600 font-bold text-sm transition bg-gray-50 hover:bg-indigo-50 px-4 py-2 rounded-lg border border-gray-200 hover:border-indigo-200">
                ...
                <form action="{{ route('bills.store') }}" method="POST" id="billForm">
                    ...
                    <div class="bg-indigo-50/50 p-6 rounded-xl border border-indigo-100 mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                            <label class="cursor-pointer relative">
                                ...
                                <div class="p-4 bg-white border border-gray-200 rounded-xl hover:shadow-md transition peer-checked:border-indigo-500 peer-checked:ring-2 peer-checked:ring-indigo-200 peer-checked:bg-white">
                                    <span class="font-bold text-gray-700 flex items-center gap-2">
                                        <span class="w-4 h-4 rounded-full border border-gray-300 peer-checked:bg-indigo-600 peer-checked:border-indigo-600 block"></span>
                                        Per Siswa
                                    </span>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-1 gap-6">
                            <div id="input-student" class="w-full">
                                ...
                                <select name="student_id" class="w-full rounded-lg border-gray-300 focus:ring-indigo-500 focus:border-indigo-500 shadow-sm">
                            ...
                            <div id="input-class" class="w-full hidden">
                                ...
                                <select name="class_name" class="w-full rounded-lg border-gray-300 focus:ring-indigo-500 focus:border-indigo-500 shadow-sm">
                    ...
                    <div class="mb-8">
                        ...
                        <select name="type" id="typeSelector" class="w-full rounded-lg border-gray-300 font-bold text-gray-800 shadow-sm focus:ring-blue-500 focus:border-blue-500 text-lg py-3" onchange="toggleFormType()">
                    ...
                    <div id="form-spp" class="bg-blue-50 p-8 rounded-xl border border-blue-200 mb-8 relative overflow-hidden">
                        ...
                        <div class="flex items-center gap-3 mb-6 relative z-10">
                            <div class="p-2 bg-blue-600 text-white rounded-lg shadow-lg shadow-blue-200">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6 relative z-10">
                            <div>
                                ...
                                <select name="spp_month" class="w-full rounded-lg border-blue-300 focus:border-blue-500 focus:ring-blue-500 bg-white shadow-sm">
                            ...
                            <div>
                                ...
                                <select name="spp_year" class="w-full rounded-lg border-blue-300 focus:border-blue-500 focus:ring-blue-500 bg-white shadow-sm">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" name="spp_amount" placeholder="0" class="w-full rounded-lg border-blue-300 focus:border-blue-500 focus:ring-blue-500 pl-10 font-bold text-gray-800 shadow-sm text-lg">
                                </div>
                    ...
                    <div id="form-regular" class="hidden">
                        <div class="mb-8">
                            ...
                            <input type="text" name="name" placeholder="Contoh: Pembelian Seragam Lengkap" class="w-full rounded-lg border-gray-300 focus:ring-blue-500 focus:border-blue-500 shadow-sm">
                        </div>
                                    ...
                                    <tbody id="items-container">
                                        <tr class="item-row border-b border-gray-100 bg-white hover:bg-gray-50 transition">
                                            <td class="px-4 py-3 align-top">
                                                <select class="type-selector w-full text-sm rounded-lg border-gray-300 focus:border-blue-500 py-2">
                                                    <option value="manual">Input Manual</option>
                                                    <option value="bundle">📦 Paket POS</option>
                                                </select>
                                            </td>
                                            <td class="px-4 py-3 align-top">
                                                <input type="text" name="item_names[]" placeholder="Nama Item / Keterangan" class="input-name w-full text-sm rounded-lg border-gray-300 py-2 focus:ring-blue-500 focus:border-blue-500">
                                                <input type="hidden" name="item_bundle_ids[]" class="input-bundle-id">
                                                
                                                <select class="select-bundle w-full text-sm rounded-lg border-gray-300 py-2 hidden focus:ring-blue-500 focus:border-blue-500">
                                            ...
                                            <td class="px-4 py-3 align-top">
                                                <input type="number" name="item_qtys[]" value="1" min="1" class="w-full text-center text-sm rounded-lg border-gray-300 py-2 focus:ring-blue-500 focus:border-blue-500">
                                            </td>
                                            <td class="px-4 py-3 align-top">
                                                <input type="number" name="item_prices[]" placeholder="0" class="input-price w-full text-right text-sm rounded-lg border-gray-300 py-2 font-bold text-gray-700 focus:ring-blue-500 focus:border-blue-500">
                                            </td>
                                    ...
                                    <tfoot class="bg-gray-50">
                                        <tr>
                                            <td colspan="5" class="px-4 py-3">
                                                <button type="button" id="add-row" class="text-blue-600 font-bold text-sm flex items-center gap-2 hover:bg-blue-100 px-3 py-1.5 rounded-lg transition">
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-4 py-4 text-right font-extrabold text-2xl text-blue-700" id="grand-total">Rp 0</td>
                                            <td></td>
                                        </tr>
                                    </tfoot>
                                </table>
                    ...
                    <div class="flex justify-end pt-6 border-t border-gray-100">
                        <button type="submit" class="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-bold py-3 px-8 rounded-xl shadow-lg shadow-blue-200 transition transform hover:-translate-y-1 flex items-center gap-2">
